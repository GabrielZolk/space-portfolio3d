...
loader.load('/solar_system2/scene.gltf', function (gltf) {
  const solarSystem = gltf.scene;
  scene.add(solarSystem);
  solarSystem.position.set(-10, 0, 0);
});

loader.load('/rocket/scene.gltf', function (gltf) {
...
loader.load('/cartoon_rocket/scene.gltf', function (gltf) {
...
loader.load('/astronaut_swimming/scene.gltf', function (gltf) {
